...
**COMPETITOR: RoosterMoney (NatWest)**
- **Target audience:** Intact families or general users seeking financial literacy.
- **Key features (bullets):** 
    - Trackable pocket money.
    - Chore lists.
    - Prepaid debit card.
...
- **Key features (bullets):**
    - "Earn, Save, Spend" missions.
    - Educational missions for kids.
...
- **Key features (bullets):**
    - Expense tracking.
    - Shared calendars.
    - Court-ordered communication logs.
...
- **Key features (bullets):**
    - Payment tracking (AppClose Solo).
...
- **Common weaknesses across competitors:** High subscription costs, lack of legal-grade data integrity for financial records, and failing to serve the child's literacy and the parents' legal needs simultaneously.
- **White-space opportunities:** The "Poland" Pivot (bilingual GBP/PLN expat market) and AI-driven mediation (Tone Meter) to de-escalate financial conflict.
...
- **3 differentiators to emphasise:**
    ...
    - **AI Tone Meter:** Automated mediation that neutralises aggressive communication.
    - **Bilingual Expat Support:** Dedicated tools for the UK-Polish financial corridor.
- **Proof points needed:** Court-admissible PDF exports with cryptographic fingerprints and alignment with UK MaPS and Polish NSFE education standards.
